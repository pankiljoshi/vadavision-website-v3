      ...
      <div className="w-full px-20 py-20 padding-full-website flex-col justify-start padding-industies our-team-bg items-start gap-14 inline-flex">
        ...
        >
          ...
          <div className="w-[260px] h-[448px] teams-cards px-4 bg-gradient-to-b from-stone-950 via-neutral-800 to-stone-950 border border-stone-950 border-opacity-0">
            ...
            <div className=" text-stone-300 text-[14px] font-light leading-tight mt-4 urbanist">
              Neeraj, React frontend developer, specializes in crafting engaging
              user interfaces for dynamic and captivating web applications.
            </div>
            <div className="justify-start items-start gap-4 mt-8 inline-flex">
          ...
          <div className="w-[260px] h-[448px] teams-cards px-4 bg-gradient-to-b from-stone-950 via-neutral-800 to-stone-950 border border-stone-950 border-opacity-0">
            ...
            <div className=" text-stone-300 text-[14px] font-light leading-tight mt-4 urbanist">
              Sabahat, transitioning from developer to product designer, brings
              over 3 years' experience and a strong emphasis on user experience.
            </div>
            <div className="justify-start items-start gap-4 mt-8 inline-flex">
              <div className="w-8 h-8 p-2 cursor-pointer border border-zinc-900 justify-center items-center flex">
                <div className="w-4 h-4  flex-col justify-start items-start flex">
          ...
          <div className="w-[260px] h-[448px] teams-cards px-4 bg-gradient-to-b from-stone-950 via-neutral-800 to-stone-950 border border-stone-950 border-opacity-0">
            ...
            <div className=" text-stone-300 text-[14px] font-light leading-tight mt-4 urbanist">
              Ajay, Full Stack Developer with 2.5 years' expertise, excels in
              React, Angular, Node.js, and databases, delivering robust web
              solutions.
            </div>
            <div className="justify-start items-start gap-4 mt-8 inline-flex">
              <div className="w-8 h-8 p-2 cursor-pointer border border-zinc-900 justify-center items-center flex">
                <div className="w-4 h-4  flex-col justify-start items-start flex">
                  <Link
                    target="_blank"
                    href="https://www.linkedin.com/in/ajay-vataliya-92094a1a0/"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="16"
          ...
          <div className="w-[260px] h-[448px] teams-cards px-4 bg-gradient-to-b from-stone-950 via-neutral-800 to-stone-950 border border-stone-950 border-opacity-0">
            ...
            <div className=" text-stone-300 text-[14px] font-light leading-tight mt-4 urbanist">
              Ritik Dwivedi, proficient full stack developer, boasts a four-year
              track record, adept in front-end and back-end tech for robust
              solutions.
            </div>
            <div className="justify-start items-start gap-4 mt-8 inline-flex">
              <div className="w-8 h-8 p-2 cursor-pointer border border-zinc-900 justify-center items-center flex">
          ...
          <div className="w-[260px] h-[448px] teams-cards px-4 bg-gradient-to-b from-stone-950 via-neutral-800 to-stone-950 border border-stone-950 border-opacity-0">
            ...
            <div className=" text-stone-300 text-[14px] font-light leading-tight mt-4 urbanist">
              Prashant, a fresher, brings over 9 months of frontend experience,
              showcasing proficiency in developing user-friendly interfaces.
            </div>
            <div className="justify-start items-start gap-4 mt-8 inline-flex">
              <div className="w-8 h-8 p-2 cursor-pointer border border-zinc-900 justify-center items-center flex">
                <div className="w-4 h-4  flex-col justify-start items-start flex">
          ...
          {/* <div className="w-[260px] h-[448px] teams-cards px-4 bg-gradient-to-b from-stone-950 via-neutral-800 to-stone-950 border border-stone-950 border-opacity-0">
            ...
            <div className=" text-stone-300 text-[14px] font-light leading-tight mt-4 urbanist">
              Neesha, interning at Vadavision, blends HR and Business
              Development skills, dedicated to fostering connections and driving
              growth.
            </div>
            <div className="justify-start items-start gap-4 mt-8 inline-flex">
              <div className="w-8 h-8 p-2 cursor-pointer border border-zinc-900 justify-center items-center flex">
