      ...
      <div className="w-full  py-10 px-20  bg-zinc-950 padding-industies bg-opacity-90 bg-ai-bot-servises">
        ...
        <div className="max-w-screen overflow-x-auto hide-scrollbar">
          <div className="  justify-start items-start gap-20 mt-10 inline-flex whitespace-nowrap">
            ...
            <div className="justify-start cursor-pointer items-center gap-2 flex">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="28"
                height="27"
          ...
          <div className="w-[1252px] h-1 bg-zinc-600  justify-start items-center inline-flex">
            <div className="w-[314px] h-1 bg-gradient-to-r from-red-500 to-orange-500" />
          </div>
        </div>
            ...
            <div className=" flex-col w-[800px] responsive-content-aiservises justify-start items-start gap-8 inline-flex">
              <div className="flex-col  justify-start items-start gap-6 flex">
                ...
                <div className=" text-neutral-400 text-base font-light font-urbaninst">
                  ...
                  generate meaningful responses. However, the quality of the
                  data used during integration is crucial for ensuring the
          ...
          <div className="flex-col justify-center items-center gap-10 inline-flex">
            <div className="w-[150px] h-[150px] relative bg-teal-600 rounded-[30px]">
              <svg
                ...
                fill="none"
              >
                <rect x="0.5" width="150" height="150" rx="30" fill="#10A37F" />
                <path
