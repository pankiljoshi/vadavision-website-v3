...
const AiBotServises = () => {
  return (
    <>
      <div className="w-full h-[902px] relative bg-zinc-950 bg-opacity-90 bg-ai-bot-servises">
        <div className="left-[1132px] top-[429px] absolute flex-col justify-start items-center gap-10 inline-flex">
        ...
        <div className="w-[1352px] h-1 pr-[1038px] left-[80px] top-[309px] absolute bg-zinc-600 justify-start items-center inline-flex">
          <div className="w-[314px] h-1 bg-gradient-to-r from-red-500 to-orange-500" />
        </div>
        <div className="left-[80px] top-[88px] absolute flex-col justify-start items-start gap-14 inline-flex">
          <div className="w-[508px]">
            <span className="text-neutral-400 text-[40px] font-medium font-urbaninst">
              Our amazing
              <br />
            </span>
            <span className="text-pink-600 text-[56px] gradient-heading font-bold font-urbaninst">
              AI Bot Services
            </span>
          </div>
        </div>
        <div className="left-[80px] top-[264px] absolute justify-start items-start gap-20 inline-flex">
          <div className="h-[29px] cursor-pointer justify-center items-center gap-2 flex">
            ...
            <div className="text-white text-2xl font-normal font-urbaninst">
              ChatGPT Integration
            </div>
          </div>
          <div className="h-[29px] cursor-pointer justify-center items-center gap-2 flex">
            ...
            <div className="text-neutral-400 text-2xl font-light font-urbaninst">
              Open Source Models
            </div>
          </div>
          <div className="h-[29px] cursor-pointer justify-center items-center gap-2 flex">
        ...
        <div className="left-[80px] top-[377px] absolute flex-col justify-start items-start gap-8 inline-flex">
          <div className="flex-col justify-start items-start gap-6 flex">
            <div className="text-white text-[32px] font-normal font-urbaninst">
              Integrate ChatGPT to your application
            </div>
            <div className="w-[558px] text-neutral-400 text-base font-light font-urbaninst">
              Integrating ChatGPT for natural language understanding (NLU) and
              conversation generation involves leveraging its powerful language
              processing capabilities to comprehend user inputs and generate
              meaningful responses. However, the quality of the data used during
              integration is crucial for ensuring the effectiveness and accuracy
              of these processes.
            </div>
          </div>
          <div className="flex-col justify-start items-start gap-6 flex">
            <div className="w-[547px] text-stone-300 text-xl font-medium font-urbaninst">
        ...
        <div className="h-12 px-10 mt-14 left-[80px] top-[774px] absolute bg-[#DD4243] hover:bg-[#D53033] justify-center items-center gap-4 inline-flex">
