...
const AiBotServises = () => {
  return (
    <>
      <div className="w-full h-[902px] px-20  bg-zinc-950 bg-opacity-90 bg-ai-bot-servises">
        {/* heading */}
        ...
        {/* get in touch */}
        <div className="h-12 px-10 mt-14   bg-[#DD4243] hover:bg-[#D53033] justify-center items-center gap-4 inline-flex">
