...
import AutoDomain from "../../../../public/Images/automationdomian.png";
const AutomationDomain = () => {
  useEffect(() => {
              ...
              <div className=" flex-col w-[800px] responsive-content-aiservises justify-start items-start gap-8 inline-flex">
                <div className="flex-col w-[550px]  servises-paragraph justify-start items-start gap-6 flex">
                  <div className="text-white text-[32px] ai-bot-servise-heading  font-normal urbanist">
                    Set your marketing in Automation mode -save your time{" "}
                  </div>
                  <div className=" text-neutral-400 ai-servise-paragraph  leading-snug text-base font-light urbanist">
                    n today fast-paced digital landscape, marketing automation
                    has emerged as a powerful tool for businesses looking to
                    streamline their processes, save time, and maximize
                    efficiency. By leveraging automation tools and strategies,
                    businesses can optimize their marketing efforts, reach their
                    target audience more effectively, and ultimately drive
                    better results.
                  </div>
                </div>
