...
const HowItsWork = () => {
  ...
  return (
    <>
      <div className="w-full px-20 py-20 padding-industies padding-full-website bg-gradient-to-r how-is-work-bg from-zinc-950 to-zinc-950">
          ...
          >
            <div className="w-full h-[130px] aumtomation-cards flex gap-11 items-center px-10  bg-gradient-to-r from-stone-950 via-zinc-900 to-neutral-900 cards-border-style">
              ...
              <div className=" flex-col justify-start items-start gap-4 inline-flex">
                ...
                <div className="w-full automation-cards-width text-[#8E8E8E] text-base font-light urbanist">
                  Set up triggers for actions or a particular time to get the
                  data.
                </div>
              </div>
            </div>
            <div className="w-full h-[130px]  aumtomation-cards flex items-center gap-11 px-10  bg-gradient-to-r from-stone-950 via-zinc-900 to-neutral-900 custom-border-style">
              ...
              <div className="  flex-col justify-start items-start gap-4 inline-flex">
                ...
                <div className="w-full automation-cards-width text-neutral-400 text-base font-light furbanist">
                  Customise your automation, activate integrations of your
                  choice.
                </div>
              </div>
            </div>
            <div className="w-full h-[130px] aumtomation-cards flex items-center px-10 gap-11  bg-gradient-to-r from-stone-950 via-zinc-900 to-neutral-900 custom-border-style">
              <div className=" text-zinc-600 text-[56px] font-bold urbanist]">
                03
              </div>
              <div className="  flex-col justify-start items-start gap-4 inline-flex">
                ...
                <div className="w-full automation-cards-width text-neutral-400 text-base font-light urbanist">
