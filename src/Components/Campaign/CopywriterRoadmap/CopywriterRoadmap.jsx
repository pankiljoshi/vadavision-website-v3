    ...
    <>
      ...
      >
        <div className="w-full lg:w-[40%] text-center lg:text-left">
          <div className="text-white dark:text-black text-center text-[28px] sm:text-[32px] lg:text-[40px] font-bold leading-tight">
            Get <span className="text-[#6CE9B9] dark:text-[#DD4243] font-extrabold">FREE</span>  Instant Access To Your Expert Design Audit Now
          </div>
          <div className="text-[18px] sm:text-[20px] text-center lg:text-[22px] font-semibold pt-8 dark:text-black text-white">
