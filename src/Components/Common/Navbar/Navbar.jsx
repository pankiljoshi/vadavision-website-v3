        ...
        <div className="NavigationWeb w-full px-20 overflow-x-hidden padding-full-website  padding-none bg-white bg-opacity-5 border border-neutral-900 ">
              ...
              <div className="">
                <div className="Frame  justify-start items-center gap-8 inline-flex">
                  <Link onClick={handleClosePopup} href="/">
                    ...
                    >
                      <span
                        className={`ml-2 urbanist font-light transition-colors duration-300 ${
                          pathname === "/" || isHomeHovered
                            ? "text-white"
                            : "text-[#8E8E8E]"
                        }`}
                      >
                      ...
                      <span
                        className={`absolute top-[-2px] left-0 transform transition-opacity duration-100 ease-in-out
          ...
          `}
                  ...
                  <Link onClick={handleClosePopup} href="/about-us">
                    ...
                    >
                      <span
                        className={`ml-1 urbanist font-light transition-colors duration-100 ${
          ...
          `}
                  ...
                  <div className="Frame3 justify-start items-center gap-1 flex">
                    ...
                    >
                      <div>
                        {isPopupOpen && (
                          <div className="absolute inset-0 backdrop-blur-[8px] responsive-servise-dropdown mt-[56px] flex z-10">
                                ...
                                <div className="w-full flex flex-row gap-6">
                                  ...
                                  {isUiUXVisible && (
                                    <div className="ai-servises-card w-96 h-96  mt-10 p-4 pb-10 border border-neutral-600 flex-col justify-start items-start  inline-flex">
                                      ...
                                      <div className="Frame1171281498 self-stretch flex-col justify-start items-start gap-4 inline-flex">
                                        <div className="DiscussYourAiProjectsWithUs w-96 pt-4 text-neutral-400 text-base font-light urbanist">
                                          Discuss your UI and UX projects with
                                          us{" "}
                                        </div>
                      ...
                      >
                        <span
                          className={`font-light urbanist transition-colors duration-300 ${
                            isServiceHovered ? "text-white" : "text-[#8E8E8E]"
                          }`}
                        >
                          Services
                        </span>
