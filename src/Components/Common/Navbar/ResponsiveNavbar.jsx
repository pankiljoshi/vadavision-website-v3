      ...
      <div className="Hero w-full relative bg-gradient-to-br from-black to-zinc-950 flex-col padding-none justify-start items-start inline-flex">
        <div className="MenuItems flex-col justify-start items-start  inline-flex">
          ...
          <div
            ...
            className="Frame1000003592 py-3 pl-10 border-b border-stone-900 justify-center items-end gap-64 inline-flex"
          >
          ...
          {isPopupOpen && (
            <div className="flex flex-col flex-wrap">
              <div>
                <div className="Card w-[393px] px-4  py-4  bg-gradient-to-b from-stone-950 via-neutral-900 to-stone-950 border border-stone-900 flex-col justify-start items-start gap-2.5 inline-flex">
              ...
              <div className="flex flex-row gap-5 mt-4  ">
                <div className="Card w-[190px]  p-4 bg-gradient-to-b from-stone-950 via-neutral-900 to-stone-950 border border-stone-900 flex-col justify-start items-start gap-2.5 inline-flex">
              ...
              <div className="Card w-[393px] px-4 py-4 mt-4 bg-gradient-to-b from-stone-950 via-neutral-900 to-stone-950 border border-stone-900 flex-col justify-start items-start gap-2.5 inline-flex">
                <div className="Frame1171281439 self-stretch h-20 flex-col justify-start items-start gap-4 flex">
                  <div className="Frame1171281438 self-stretch h-10 flex-col justify-start items-start gap-2 flex">
                    <div className="Frame1171281491 justify-start items-center gap-2 inline-flex">
                      <div className="Workflow1 w-4 h-4 relative">
                        <svg
                          ...
                          fill="none"
                        >
                          <g id="workflow 1" clipPath="url(#clip0_702_13785)">
                            <g id="Group">
                              <g id="Group_2">
                                <path
                                  id="Vector"
                    ...
                    <div className="Frame1171281491 justify-start items-center gap-2 inline-flex">
                      <div className="Resource1 w-4 h-4 relative">
                        <svg
                          ...
                          fill="none"
                        >
                          <g id="resource 1" clipPath="url(#clip0_702_13812)">
                            <path
                              id="Vector"
