  ...
  return (
    <>
      <div className="flex flex-col justify-center">
        <div className="w-full flex flex-row error-bg px-20 gap-44    bg-no-repeat items-center  ">
          <div className="w-[50%] flex-col justify-start items-center gap-6 inline-flex">
            ...
            <div className="h-12 px-6 py-4 bg-red-500 justify-center items-center gap-4 inline-flex">
          ...
          <div className="w-[50%]">
            <Image src={ErrorImage} width={450} />
          </div>
        </div>
      </div>
    </>
