...
const NewsLetter = () => {
  ...
  return (
    <>
      <div className=" w-full  py-4 justify-between padding-full-website overflow-x-hidden newsletter-mobile-margin newsletter-responsive  padding-industies px-20 items-center gap-10 inline-flex">
        <div
          data-aos="fade-right"
