  ...
  return (
    <>
      <div className="unique-gradient-background  mobile-view-gradient-bg">
        <div className=" w-full Unique bg-cover padding-full-website   px-20 py-10 bg-right-top  pt-10 bg-no-repeat  padding-industies ">
          <div className="">
            ...
            >
              ...
              <div className="unique-cards p-4 w-[395px] h-[155px] card-height2 bg-no-repeat  border-gradient-bottom border-gradient-top border-gradient-right border-t border-b border-r border-zinc-800  background-gradient  flex-col justify-start items-start gap-6 inline-flex">
                <div className="Frame1171281468  self-stretch justify-start items-start gap-4 inline-flex">
                  <div className="HighQuality1 w-6 h-6 relative">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
              ...
              <div className="unique-cards p-4  w-[395px] h-[155px] card-height3   bg-no-repeat  border-gradient-bottom border-gradient-top border-gradient-right border-t border-b border-r border-zinc-800  background-gradient  flex-col justify-start items-start gap-6 inline-flex">
                <div className="Frame1171281468  self-stretch justify-start items-start gap-4 inline-flex">
                  <div className="HighQuality1 w-6 h-6 relative">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
