            ...
            <div className="flex flex-row gap-6">
              <div className="flex flex-col">
                <div className="flex flex-row gap-6  mt-10">
                  <div className="Card w-72 h-48 p-6 bg-gradient-to-b from-stone-950 via-neutral-900 to-stone-950 group hover:border hover:border-neutral-400 flex-col justify-start items-start gap-2.5 inline-flex">
                  ...
                  {isPopupOpen && <UiUxDesign onClose={closePopup} />}
