    ...
    <>
      <div className="w-full py-20 px-20 padding-industies responsive-recent-client  justify-start items-start gap-60 inline-flex">
        ...
        <div className="self-stretch justify-start items-start gap-14 recent-client-cards inline-flex">
          <div className="w-[187px] h-32 pl-6 pr-[23.58px] py-5 bg-neutral-900 rotation360  justify-center items-center flex">
            <Image src={Rotation360} width={190} />
          </div>
          <div className="w-[187px] h-32 pl-[29px] pr-[28.59px] py-5 bg-neutral-900  rotation360 justify-center items-center flex">
            <Image src={Otgc} width={150} />
          </div>
          <div className="w-[187px] h-32 px-4 py-[43px] bg-neutral-900  justify-center  rotation360 items-center flex">
